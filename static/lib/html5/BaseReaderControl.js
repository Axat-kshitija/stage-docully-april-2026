              ...
              success: function(data) {
                if (me.isDefaultServerUrl) {
                  console.warn('Annotation data was requested from the default PHP server URL.\n' +
                                        ...
                                        'Please see this link for more information on configuring annotation loading https://www.pdftron.com/documentation/web/guides/basics/annotations/saving-loading-annotations');
                }
    ...
    exportAnnotations: function(options) {
      if (this.serverUrl === null) {
        console.warn('No server URL was specified so annotations were not able to be saved.\n' +
                    'Please see this link for more information on configuring annotation saving https://www.pdftron.com/documentation/web/guides/basics/annotations/saving-loading-annotations');
        return;
      }
