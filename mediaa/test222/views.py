                        ...
                        if pathsort2[-1]=='pdf' or pathsort2[-1]=='PDF':
                                            ...
                                            if data23 and watermakingcheck==True:
                                                                        ...
                                                                        # print(temp_path2,'oooooooooooooooooo')
                                                                            ...
                                                                            context_data['path']='https://services.docullyvdr.com/projectName/media/fileviewcatche/'+str(tempfile)
                                                                            context_data['pathpptpdf']=context_data['path']
...
def downloadingfilesfortesting(request, pk):
    ...
    if request.method == "GET":
        import os
        os.chdir("/home/Docully/cdms2/mediaa/")
        name1 = "test123.xls"
        with open("/home/Docully/cdms2/mediaa/test123.xlsx", 'rb') as ifh:
            read_data=ifh.read()
            with open("/home/Docully/cdms2/DocFile_server/test123.xlsx", 'wb') as fileee:
                fileee.write(read_data)
                # #print("yes done pptx 8888888888888888888888888888888888888888888888899999999999999999999999999999999")
        convert_to1('/home/Docully/cdms2/mediaa/',  "/home/Docully/cdms2/mediaa/test222/XLS Testing - multiple sheets.xls")
